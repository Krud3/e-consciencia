...
export function SeaGull2({ orbitCenter = [0,0,0], radius = 20, angleOffset = 0, speed = 0.5, ...props }) {
  const group = useRef()
  const angleRef = useRef(0)
  const { nodes, materials, animations } = useGLTF('/3d-models-contamination/seagull2.glb')
...
export default SeaGull2
useGLTF.preload('/3d-models-contamination/seagull2.glb')
